...
// Emotion's css function is being used in a tagged template literal
// to render the styles defined in backticks ( `` ) on the HTML element

// Here we defined six shades of gray, two shades of the primary
// color for our app, two shades of an accent color, as well as the font
// family we'll use with the standard font size
